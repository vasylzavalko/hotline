			...
			<div data-uk-grid>
                ...
                <div class="uk-width-expand">
                    <div data-uk-grid>
                        ...
                        <div class="uk-width-1-1">
                            <div class="box-border">
                                ...
                                <div data-uk-grid class="uk-grid-small">
                                    ...
                                    <?php if ($entries['status']!=5) { ?>
                                    <div hidden class="uk-width-auto uk-flex uk-flex-middle">
                                    ...
                                    <?php if ($entries['status']!=5) { ?>                                    
                                    <div hidden id="add-head" class="uk-width-1-1" <?php if( isset($appealUser[2]) ){ echo "hidden"; } ?> >
                                        <form method="post" action="<?php echo current_url(true); ?>" data-uk-grid class="uk-grid-small">
                                            <?php if( isset($appealUser[2]) ){ ?>
                                            <div class="uk-width-1-1"><hr></div>
                                            <?php } ?>
                        ...
                        <div class="uk-width-1-1" <?php if( count($appealRequest)==0 ){ ?>hidden<?php } ?>>
                            <div class="box-border">
                ...
                <div class="uk-width-1-3@l">
                    <div data-uk-grid>
                        ...
                        <div class="uk-width-1-1 uk-text-center">
                            <?php if ($entries['status']==6) { ?>
                            <a href="#status-close" class="uk-button uk-button-primary uk-button-large uk-width-1-1" data-uk-toggle><?php echo lang('Manager.add_status_done') ?></a>
                            <div id="status-close" class="uk-flex-top" data-uk-modal="bg-close:false">
                                <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
                                    ...
                                    <form method="post" action="<?php echo current_url(true); ?>" data-uk-grid class="uk-grid-small">
                                        ...
                                        <div class="uk-width-1-1"><h2><?php echo lang('Manager.comment_done_title') ?></h2></div>
                                        <div class="uk-width-1-1"><?php echo lang('Manager.comment_done_desc') ?></div>
                                        <div class="uk-width-1-1">
                                            <label><?php echo lang('Manager.comment') ?></label>
                                            <textarea class="uk-textarea" name="comment" rows="6" placeholder="<?php echo lang('Manager.comment') ?>"></textarea>
                                        </div>
                                        <div class="uk-width-1-1">
                            ...
                            <a href="#status-return" class="uk-button uk-button-danger uk-button-large uk-width-1-1 uk-margin-small-top" data-uk-toggle><?php echo lang('Manager.add_status_return') ?></a>
                            <div id="status-return" class="uk-flex-top" data-uk-modal="bg-close:false">
                                <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
                                    <button class="uk-modal-close-default" type="button" data-uk-close></button>
                                    <form method="post" action="<?php echo current_url(true); ?>" data-uk-grid class="uk-grid-small">
                                        <input hidden class="uk-input" value="<?php echo $entries['id']; ?>" type="text" name="id" required>
                                        <input hidden class="uk-input" value="4" type="text" name="status" required>
                                        <div class="uk-width-1-1"><h2><?php echo lang('Manager.comment_return_title') ?></h2></div>
                                        <div class="uk-width-1-1"><?php echo lang('Manager.comment_return_desc') ?></div>
                                        <div class="uk-width-1-1">
                                            <label><?php echo lang('Manager.comment') ?></label>
                                            <textarea class="uk-textarea" name="comment" rows="6" placeholder="<?php echo lang('Manager.comment') ?>"></textarea>
                                        </div>
                                        <div class="uk-width-1-1">
                                            <input class="uk-checkbox uk-margin-small-right" type="checkbox" name="notify" value="0"><?php echo lang('Manager.send_status_message') ?>
                                        </div>
                                        <div class="uk-width-auto uk-flex uk-flex-bottom"><button class="uk-button uk-button-primary" type="submit" name="submit" value="Submit_add_status"><?php echo lang('Manager.confirm') ?></button></div>
                                    </form>
                                </div>
