                        ...
                        <div class="uk-width-1-1">
                            <div class="box-border">
                                ...
                                <div data-uk-grid class="uk-grid-small">
                                    ...
                                    <div class="uk-width-auto uk-flex uk-flex-middle">
                                        <a href="#add-implementer" data-uk-toggle class="uk-button uk-button-primary  uk-button-small"><?php echo lang('Manager.add_fact_implementer') ?><span class="uk-margin-small-left" data-uk-icon="icon:chevron-down;ratio:.8"></span></a>
                                    </div>
                                    <?php } ?>
                                    <?php } else { ?>
                                    <div class="uk-width-expand">
                                    ...
                                    <div id="add-implementer" class="uk-width-1-1" <?php if( isset($appealUser[3]) ){ echo "hidden"; } ?> >
                                        <form method="post" action="<?php echo current_url(true); ?>" data-uk-grid class="uk-grid-small">
                                            ...
                                            <div class="uk-width-auto uk-flex uk-flex-bottom"><button class="uk-button uk-button-primary" type="submit" name="submit" value="Submit_add_implementer_user"><?php echo lang('Manager.add') ?></button></div>
                                        </form>
                                    </div>
                                    <?php } ?>
                                </div>
                ...
                <div class="uk-width-1-3@l">
                    <div data-uk-grid>
                        ...
                        <div class="uk-width-1-1 uk-text-center">
                            <?php if ($entries['status']==7) { ?>
                            <a href="#status-close" class="uk-button uk-button-primary uk-button-large uk-width-1-1" data-uk-toggle><?php echo lang('Manager.add_status_inwork') ?></a>
                            <div id="status-close" class="uk-flex-top" data-uk-modal="bg-close:false">
                                <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
                                    ...
                                    <form method="post" action="<?php echo current_url(true); ?>" data-uk-grid class="uk-grid-small">
                                        ...
                                        <div class="uk-width-1-1"><h2><?php echo lang('Manager.comment_inwork_title') ?></h2></div>
                                        <div class="uk-width-1-1"><?php echo lang('Manager.comment_inwork_desc') ?></div>
                                        <div class="uk-width-1-1">
                                            <label><?php echo lang('Manager.comment') ?></label>
                                            <textarea class="uk-textarea" name="comment" rows="6"></textarea>
                                        </div>
                        ...
                        <div class="uk-width-1-1">
                            <div class="box-border">
                                <div class="box-border-label"><?php echo lang('Manager.status_box') ?></div>
                                <div data-uk-grid class="uk-grid-small">
                                    <div class="uk-width-1-1">
                                        <table class="uk-table uk-table-margin-remove uk-table-small uk-table-justify uk-table-divider">
    ...
    $.getJSON(jsonUrl, function(data) {
		...
		if(data.length!=0){
			...
			$.each(data, function(key, val) {
				$(divGallery+" div ul").append('<li class="uk-width-small"><a href="'+dirGallery+val.image+'"><div class="uk-cover-container"><canvas width="300" height="300"></canvas><img src="'+dirGallery+val.image+'" data-uk-cover></div></a><span class="work-delete" data-id="'+key+'" data-work="'+work+'"></span></li>');
			});
